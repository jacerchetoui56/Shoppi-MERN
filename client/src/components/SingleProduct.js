  ...
  async function getProduct() {
    try {
      const { data } = await axios.get(
        `https://shoppi-server.onrender.com/api/v1/products/product/${Id}`
      );
      if (!data.success) {
        navigate("*");
      } else {
      ...
      <div className="container">
        <div className="card">
          ...
          <div className="infos">
            ...
            <div
              className={loggedIn ? "product-buttons" : "product-buttons Not"}
            >
              <span
      ...
      <div className="informations">
        <div className="informations-top">
          <div
            ...
            className={
              activeOption === "description" ? "option active" : "option"
            }
          >
            Description
          </div>
        ...
        <div className="informations-content">
          ...
          {activeOption === "author" && (
            <section className="product-author">
              <h3>{author}</h3>
            </section>
          )}
                  ...
                  return (
                    <div key={index} className="comment">
                      <div>
                        <div className="image">
                          <img
                            src="images/comments/avatar.png"
                            alt={comment.name}
                          />
                        </div>
                        <div>
          ...
          {activeOption === "reviews" && (
            <p>
              ...
              itaque laborum voluptates qui consequuntur numquam repellat illum
              accusantium animi.
            </p>
          )}
        </div>
