...
import { HiOutlineHome, HiOutlineDeviceTablet, HiOutlineMail } from 'react-icons/hi'
...
export default function Contact() {
    ...
    async function handleSubmit(e) {
        e.preventDefault()
        try {
            const { data } = await axios.post('http://localhost:5000/api/v1/inbox', {
                ...form
            })
            if (data.success) {
            ...
            <div className="container">
                <main>
                    <form className="contact-form" onSubmit={handleSubmit}>
                        ...
                        <div>
                            <textarea
                                required placeholder='Enter Message'
                                cols="30" rows="10"
                                name='message'
                                maxLength={200}
                            ...
                            ></textarea>
                            <input
                                required placeholder='Enter Yout Name'
                                type="text"
                                className='name'
                                name="name"
                                onChange={handleChange}
